...
def make_users_file(user_id):
    file_path = 'bot/data/files/to_send/users.xlsx'
...
def make_class_managers_file():
    file_path = 'bot/data/files/to_send/class_managers.xlsx'
...
def make_olympiads_with_dates_file():
    file_path = 'bot/data/files/to_send/all_olympiads.xlsx'
...
def make_olympiads_status_file(user_id=None, teaching=None):
    ...
    olympiads_status = olympiads_status.join(subjects.set_index('id'), on='subject_id', rsuffix='subject_')
...
def make_answers_file():
    file_path = 'bot/data/files/to_send/answers_file.xlsx'
    answers = get_answers()
    admins = get_admins()
